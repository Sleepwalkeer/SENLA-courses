...
public class ItemServiceTest {
    ...
    public void getAllTest() {
        ...
        List<ItemDto> retrievedItemDtos = itemService.getAll(1,2,"id");
    ...
    public void getAllWithDatabaseAccessExceptionTest() {
        Pageable paging = PageRequest.of(1, 2, Sort.by("id"));
        when(itemRepository.findAll(paging)).thenThrow(new RuntimeException());
        Assertions.assertThrows(DatabaseAccessException.class, () -> itemService.getAll(1,2,"id"));
        verify(itemRepository).findAll(paging);
    }
}
